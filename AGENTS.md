...
- The CLI's agent skill is `skills/grimoire-cli/SKILL.md`, embedded in the binary and installed by `grimoire skill install DIR`. A change to a CLI verb updates it in the same commit.
