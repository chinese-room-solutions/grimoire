...
// startApp launches the freshly staged Grimoire detached, with no arguments (the
// GUI). The installer exits immediately after, so the child must not be tied to
// it — hence Release and the discarded streams.
